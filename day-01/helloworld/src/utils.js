...
async function getMoviesBySearchTerm(searchTerm) {
    const searchURL = `http://www.omdbapi.com/?type=movie&t=${searchTerm}&apikey=`;
    try {
...
async function getMoviesBySearchId(searchIdInput) {
    const searchIdURL = `http://www.omdbapi.com/?type=movie&t=${searchIdInput}&apikey=`;
    try {
...
export default getMoviesBySearchId(searchIdInput);
export default startIdSearch();
export default getMoviesBySearchTerm(searchTerm);
